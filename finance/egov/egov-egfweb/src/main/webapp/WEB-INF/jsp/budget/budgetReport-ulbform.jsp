...
<script>
	function validateFinYear(method) {
	    if (document.getElementById('ulb').value == 0) {
			bootbox.alert('<s:text name="msg.please.select.ulb"/>');
			return false;
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td class="greybox"><s:text name="report.ulb" /> <span class="mandatory"></span></td>
<td class="greybox">
    <s:select name="ulb"
              id="ulb"
              list="dropdownData.ulbList"
              listKey="value" 
              listValue="key" 
              headerKey="0"
              headerValue="%{getText('lbl.choose.options')}" value="%{ulb}"/>
</td>
