...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin">
		<form:input path="name" id="name" size="40" maxlength="100"
			cssClass="form-control patternvalidation"
			data-pattern="alphabetWithSpecialCharForContraWOAndSupplierName"
			required="required" />
...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin">
		<form:textarea path="correspondenceAddress" cols="35"
			cssClass="form-control textfieldsvalidate patternvalidation"
			id="correspondenceAddress" data-pattern="address" maxlength="250"
			required="required" />
		<form:errors path="correspondenceAddress"
			cssClass="add-margin error-msg" />
	</div>
	<label class="col-sm-2 control-label text-right" for="paymentAddress">
		<spring:message code="contractor.paymentAddress"
			text='Permanent Address' />
	</label>
	<div class="col-sm-3 add-margin">
		<form:textarea path="paymentAddress" cols="35"
			cssClass="form-control textfieldsvalidate patternvalidation"
			data-pattern="address" id="paymentAddress" maxlength="250" />
...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin contactPerson">
		<form:input path="contactPerson" id="contactPerson" size="40"
			maxlength="100" cssClass="form-control patternvalidation"
			data-pattern="alphabetwithspace" required="required" />
		<form:errors path="contactPerson" cssClass="add-margin error-msg" />
	</div>
	<label class="col-sm-2 control-label text-right" for="email"> <spring:message
			code="contractor.email" text='Email' />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin">
		<form:textarea path="narration" cols="35"
			cssClass="form-control textfieldsvalidate" id="narration"
			maxlength="250" />
		<form:errors path="narration" cssClass="add-margin error-msg" />
	</div>
	<label class="col-sm-2 control-label text-right" for="mobileNumber">
		<spring:message code="lbl.mobile" text='mobile' /><span
		class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
		<form:input path="mobileNumber" id="mobileNumber" maxlength="10"
...
<div class="form-group">
	...
	<label class="col-sm-2 control-label text-right"
		for="gstRegisteredState"> <spring:message
			code="contractor.gst.registered.state" text='GST registered State/UT' /><span
		class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	...
	<div class="col-sm-2 col-xs-12 add-margin">
		<div class="radio">
			<label><form:radiobutton path="contractorType"
					id="contractorType" value="FIRM" checked="checked" />
	...
	<div class="col-sm-2 col-xs-12 add-margin">
		<div class="radio">
			<label><form:radiobutton path="contractorType"
					id="contractorType" value="INDIVIDUALS" />
...
<div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3 add-margin">
			<form:input path="epfNumber" id="epfNumber" maxlength="24"
				cssClass="form-control patternvalidation" data-pattern="specialName" />
			<form:errors path="epfNumber" cssClass="add-margin error-msg" />
		</div>
		<label class="col-sm-2 control-label text-right" for="esiNumber">
			<spring:message code="contractor.esiNo" text='ESI No' />
		</label>
		<div class="col-sm-3 add-margin">
			<form:input path="esiNumber" id="esiNumber" maxlength="21"
				cssClass="form-control patternvalidation"
				data-pattern="numericslashhyphen" />
