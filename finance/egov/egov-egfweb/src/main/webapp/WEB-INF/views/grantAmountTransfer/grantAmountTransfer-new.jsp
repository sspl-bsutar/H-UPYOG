...
<script>
    $(document).ready(function() {
         ...
         $('select[data-field-type="ulbName"]').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "/services/EGF/grantsfund/ulbcodeMapping/"+ ulbName,
...
<script> 
    $(document).ready(function() {
         ...
         $('select[data-field-type="bankAccountType"]').change(function() {
            ...
            $.ajax({
                type: "GET",
                url: "/services/EGF/grantsfund/bankMapping/"+ bankAccountType,
                success: function(response) {
                    console.log(response);
                    var len = response.length;
                    $("#bankId").empty();
...
<script> 
    $(document).ready(function() {
         ...
         $('select[data-field-type="bankId"]').change(function() {
            ...
            $.ajax({
                type: "GET",
                url: "/services/EGF/grantsfund/bankAccountMapping/"+ bankId,
                success: function(response) {
                    console.log(response);
                    var len = response.length;
