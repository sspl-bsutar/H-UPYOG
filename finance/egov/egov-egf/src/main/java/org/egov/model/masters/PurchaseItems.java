...
public class PurchaseItems extends AbstractAuditable implements EntityType {
	...
	public PurchaseItems(Long id, String itemCode, String unit, Long unitRate, Long gstRate, Double unitValueWithGst,
			Integer quantity, Double amount, PurchaseOrder purchaseOrder) {
		super();
		this.id = id;
		this.itemCode = itemCode;
		this.unit = unit;
