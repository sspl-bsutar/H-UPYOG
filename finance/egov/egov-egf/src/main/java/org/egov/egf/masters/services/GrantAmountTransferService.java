	...
	public GrantAmountTransfer executeNativeQuery(GrantAmountTransfer gt,String ulb) {
	 ...
	 //voucher header   
			    ...
			    String sqlQuery2 = "INSERT INTO "+ ulb +".voucherheader " +
			            ...
			            "VALUES(:maxVcId, 'JVGeneral', 'Journal Voucher', 'null', :currentDateAndTime, :vnum, :currentDate,1 ,23,0,:cgvn,:createddate)";
	   ...
	   //vouchermis 
	    ...
	    String sqlQuery3 = "SELECT COALESCE(MAX(id), 0) FROM " + ulb + ".vouchermis";
			...
			String debitGlCode = coa1.get(0).getGlcode();
			Long debitGlcodeId = coa1.get(0).getId();
			
			String creditGlCode = "45021";
			Long creditGlcodeId = 311l;
